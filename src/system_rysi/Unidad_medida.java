 ...
 * @author ErC
 */
public class Unidad_medida extends javax.swing.JPanel {
    ...
    int id_unidad_global = 0;
    String band_nombre = "";
    String band_codigo = "";
    private Component unidad_medida;
    ...
    String objeto_general = "Unidad de Medida";

    public Unidad_medida(String controlador, String DSN, String user, String password, int id_empresa, int id_usuario, String perfil_usuario) {
    ...
    private void mostrar_tabla_Unidadmedida(String consulta) {
        ResultSet r;

        try {

            if (consulta.equals("")) {
                r = sentencia.executeQuery("select id_unidad, codigo, descripcion from TUnidad_producto order by codigo asc");
            } else {
            ...
            while (r.next()) {
                fila[0] = r.getString("id_unidad").trim();
                fila[1] = r.getString("codigo").trim();
            ...
            TableColumn columna2 = tabla_general.getColumn("Codigo");
    ...
    private void crear_unidadmedida(String codigo, String descripcion, int id_empresa, int id_usuario) {
        ...
        if (clase_UnidadMedida.crear(codigo, descripcion, id_empresa, id_usuario)) {
            ...
            JOptionPane.showMessageDialog(null, "La " + objeto_general + " se registro exitosamente!");

        } else {
            JOptionPane.showMessageDialog(null, "Ocurrio al crear la " + objeto_general + ". \nPor favor inténtelo nuevamente.", "ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }

    private void modificar_unidadmedida(int id_unidad, String codigo, String descripcion, int id_empresa, int id_usuario) {
        System.out.println("ejecutandose la función: modificar_" + objeto_general + "");

        if (clase_UnidadMedida.modificar(id_unidad, codigo, descripcion, id_empresa, id_usuario)) {
            System.out.println("La " + objeto_general + " se logró modificar exitosamente!");
            ...
            JOptionPane.showMessageDialog(null, "La " + objeto_general + " se modificó exitosamente!");

        } else {
            JOptionPane.showMessageDialog(null, "Ocurrio al modificar la " + objeto_general + ". \nPor favor inténtelo nuevamente.", "ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }

    private void mostrar_datos_unidad(int id_unidad) {
        ...
        System.out.println("el id seleccionado es: " + id_unidad);
        id_unidad_global = id_unidad;
        ResultSet r;

        try {
            r = sentencia.executeQuery("select d.codigo codigo, d.descripcion descripcion, d.f_creacion f_creacion, d.f_modificacion f_modificacion, u.nombre nombre_usuario from TUnidad_producto d, tusuario u where d.id_usuario=u.id_usuario and d.id_unidad=" + id_unidad + "");
            while (r.next()) {
                System.out.println("Valores extraidos de la BD:");

                txt_codigo.setText(r.getString("codigo").trim());
                System.out.println(txt_codigo.getText().trim());
            ...
            lbl_titulo.setText("Información de la " + objeto_general + "");
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/unidad_de_medida_32_32.png"))); // NOI18N
        ...
        lbl_titulo.setText("Información de Unidad de Medida");
    ...
    private void btn_creacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_creacionActionPerformed
        ...
        dialog_fecha_creacion.setLocationRelativeTo(unidad_medida);
    ...
    private void btn_nuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_nuevoActionPerformed
        ...
        System.out.println("cambiando el titulo");
        lbl_titulo.setText("Nueva " + objeto_general + "");
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        ...
        if (txt_descripcion.getText().length() == 0 || txt_codigo.getText().length() == 0) {
            ...
            if (crear0_modificar1 == 0) {
                ...
                if (clase_UnidadMedida.codigo_existente(codigo) > 0) {
                    JOptionPane.showMessageDialog(null, "Codigo de la " + objeto_general + " existente.\n Por favor ingrese otro.", "ERROR", JOptionPane.ERROR_MESSAGE);
                } else {
                ...
                if (band_codigo.equals(txt_codigo.getText().trim())) {
                    System.out.println("El codigo es igual, se procede con la modificacion");
                    int id_unidad = id_unidad_global;
                    System.out.println("llamamos a la funcion modificar_" + objeto_general + "");
                    modificar_unidadmedida(id_unidad, codigo, descripcion, id_empresa, id_usuario);

                } else {
                    System.out.println("El codigo no es igual, se procede a aplicar restricciones");

                    if (clase_UnidadMedida.codigo_existente(codigo) > 0) {
                        System.out.println("El codigo ingresado ya se encuentra registrado");
                        JOptionPane.showMessageDialog(null, "Codigo de " + objeto_general + " existente. \n Por favor ingrese otro.", "ERROR", JOptionPane.ERROR_MESSAGE);
                    } else {
                        int id_unidad = id_unidad_global;
                        System.out.println("llamamos a la funcion modificar_" + objeto_general + "");
                        modificar_unidadmedida(id_unidad, codigo, descripcion, id_empresa, id_usuario);
    ...
    private void btn_modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modificarActionPerformed
        ...
        if (fil == -1) {
            ...
            band_codigo = txt_codigo.getText().trim();
            band_index = 1;
        }
        ...
        try {
            ...
            if (fila == -1) {
                ...
                if (respuesta == JOptionPane.YES_OPTION) {
                    ...
                    id_unidad = Integer.parseInt((String) m.getValueAt(fila, 0));
                    clase_UnidadMedida.eliminar(id_unidad);

                    System.out.println("la " + objeto_general + " se logró eliminar exitosamente!");
                    System.out.println("ocultar el panel de detalle de datos");
                    Panel_detalle.setVisible(false);
                    JOptionPane.showMessageDialog(null, "La " + objeto_general + " se Eliminó exitosamente!");
            ...
            JOptionPane.showMessageDialog(null, "Ocurrio al eliminar la " + objeto_general + ".\n Por favor intentelo nuevamente", "ERROR", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void tabla_generalMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_generalMouseReleased
        if (band_index == 0) {
            ...
            m = (DefaultTableModel) tabla_general.getModel();
            id_unidad = Integer.parseInt((String) m.getValueAt(fila, 0));
            mostrar_datos_unidad(id_unidad);
        }
    ...
    private void txt_buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_buscarKeyReleased
        ...
        consulta = "select id_unidad, codigo, descripcion from TUnidad_producto where (descripcion like '%" + bus + "%'  or codigo like '%" + bus + "%') order by codigo asc";
        mostrar_tabla_Unidadmedida(consulta);

    }//GEN-LAST:event_txt_buscarKeyReleased

    private void btn_cancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cancelarActionPerformed
        int respuesta;
        respuesta = JOptionPane.showConfirmDialog(null, "¿Está seguro que desea Cancelar el registro de la " + objeto_general + "?", "Cancelar", JOptionPane.YES_NO_OPTION);
        if (respuesta == JOptionPane.YES_OPTION) {
