 ...
 * @author ErC
 */
public class Forma_de_pago_cotizacion extends javax.swing.JPanel {
    ...
    String objeto_general = "Forma de Pago";

    public Forma_de_pago_cotizacion(String controlador, String DSN, String user, String password, int id_empresa, int id_usuario, String perfil_usuario) {
...
//        Activar_letras_Mayusculas();
    ...
    private void mostrar_tabla_Formadepago(String consulta) {
        ResultSet r;
        String estado;
        ...
        try {
            ...
            if (consulta.equals("")) {
                r = sentencia.executeQuery("select estado, id_formapago, descripcion from TFormaPago order by descripcion asc");
            } else {
            ...
            while (r.next()) {
                ...
                fila[1] = r.getString("id_formapago").trim();
    ...
    private void modificar_FormaPago(int id_formapago, String descripcion, String estado, int id_empresa, int id_usuario) {
        System.out.println("ejecutandose la función: modificar_" + objeto_general + "");

        if (clase_FormaPago.modificar(id_formapago, descripcion, estado, id_empresa, id_usuario)) {
    ...
    private void mostrar_datos_Cuentabanco(int id_formapago) {
        ...
        System.out.println("el id seleccionado es: " + id_formapago);
        id_formapago_global = id_formapago;
        ResultSet r;

        try {
            r = sentencia.executeQuery("select d.descripcion descripcion, d.estado estado, d.f_creacion f_creacion, d.f_modificacion f_modificacion, u.nombre nombre_usuario from TFormaPago d, tusuario u where d.id_usuario=u.id_usuario and d.id_formapago=" + id_formapago + "");
            while (r.next()) {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/forma_de_pago.png"))); // NOI18N
    ...
    private void btn_nuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_nuevoActionPerformed
        ...
        System.out.println("cambiando el titulo");
        lbl_titulo.setText("Nuevo Forma de Pago");
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        ...
        if (txt_descripcion.getText().length() == 0) {
            ...
            if (crear0_modificar1 == 0) {
                ...
                if (clase_FormaPago.descripcion_existente(descripcion) > 0) {
                    ...
                    String estado = "0";
                    crear_FormaPago(descripcion, estado, id_empresa, id_usuario);
                }
                ...
                if (band_descripcion.equals(txt_descripcion.getText().trim())) {
                    ...
                    int id_formapago = id_formapago_global;
                    String estado = estado_global;
                    System.out.println("llamamos a la funcion modificar_" + objeto_general + "");
                    modificar_FormaPago(id_formapago, descripcion, estado, id_empresa, id_usuario);
    ...
    private void btn_modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modificarActionPerformed
        ...
        if (fil == -1) {
            ...
            System.out.println("cambiando el titulo");
            lbl_titulo.setText("Modificar Forma de Pago");
        ...
        try {
            ...
            if (fila == -1) {
                ...
                if (respuesta == JOptionPane.YES_OPTION) {
                    ...
                    id_formapago = Integer.parseInt((String) m.getValueAt(fila, 1));
                    clase_FormaPago.eliminar(id_formapago);
    ...
    private void tabla_generalMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_generalMouseReleased
        if (band_index == 0) {
            ...
            m = (DefaultTableModel) tabla_general.getModel();
            id_formapago = Integer.parseInt((String) m.getValueAt(fila, 1));
            mostrar_datos_Cuentabanco(id_formapago);
        }
    ...
    private void txt_buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_buscarKeyReleased
        ...
        consulta = "select estado, id_formapago, descripcion from TFormaPago where descripcion like '%" + bus + "%' order by descripcion asc";
        mostrar_tabla_Formadepago(consulta);
    ...
    private void btn_activarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_activarActionPerformed
        ...
        int id_formapago = Integer.parseInt((String) m.getValueAt(fila, 1));
        ResultSet r;

        if (fila == -1) {
            JOptionPane.showMessageDialog(null, "Seleccione una FORMA DE PAGO para ACTIVAR");
        } else {
            int respuesta;
            respuesta = JOptionPane.showConfirmDialog(null, "¿Está seguro que desea ACTIVAR esta FORMA DE PAGO?", "Anular", JOptionPane.YES_NO_OPTION);
            if (respuesta == JOptionPane.YES_OPTION) {
                String estado = "0";
                int id_usuario = id_usuario_index;

                if (clase_FormaPago.activar(id_formapago, estado, id_usuario)) {
                    System.out.println("ocultar el panel de detalle de datos");
                    Panel_detalle.setVisible(false);
                    System.out.println("actualizamos tabla FORMA DE PAGO");
                    mostrar_tabla_Formadepago("");
                    band_index = 0;

                } else {
                    JOptionPane.showMessageDialog(null, "Ocurrio al ACTIVAR la FORMA DE PAGO.\n Por favor intentelo nuevamente", "ERROR", JOptionPane.ERROR_MESSAGE);
                }
            }
        }
    ...
    private void btn_desactivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_desactivarActionPerformed
        System.out.println("Ejecutandose desactivar FORMA DE PAGO");
        System.out.println("=====================================");
