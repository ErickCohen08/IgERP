...
public class Conductor extends javax.swing.JPanel {
    ...
    public Conductor(String controlador, String DSN, String user, String password, int id_empresa, int id_usuario, String perfil_usuario) {
        ...
        System.out.println("mostrar tabla Conductor");
    ...
    private void Mostrar_tabla_conductor() {
        try {
            ResultSet r = sentencia.executeQuery("select id_conductor, nombre, apellido from tconductor where id_empresa = '" + id_empresa_index + "' order by nombre asc");
    ...
    private void modificar_conductor(int id_conductor, String Nombre, String Apellido, String dni, String direccion, String telefono, String celular, String nro_licencia, int id_empresa, int id_usuario) {

        System.out.println("ejecutandose la función: modificar_conductor");

        if (clase_conductor.modificar(id_conductor, Nombre, Apellido, dni, direccion, telefono, celular, nro_licencia, id_empresa, id_usuario)) {
            System.out.println("El Conductor se logró modificar exitosamente!");
            ...
            JOptionPane.showMessageDialog(null, "El Conductor se modificó exitosamente!");

        } else {
            JOptionPane.showMessageDialog(null, "Ocurrio al modificar el Conductor. \nPor favor inténtelo nuevamente.", "ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/conductor_32_32.png"))); // NOI18N
        ...
        lbl_titulo.setText("Información del Conductor");
        ...
        norteLayout.setHorizontalGroup(
            ...
            .addComponent(lbl_titulo, javax.swing.GroupLayout.DEFAULT_SIZE, 662, Short.MAX_VALUE)
        ...
        jPanel8.setPreferredSize(new java.awt.Dimension(150, 293));
    ...
    private void btn_creacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_creacionActionPerformed
        ...
        dialog_fecha_creacion.setLocationRelativeTo(conductor);
    ...
    private void btn_nuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_nuevoActionPerformed
        ...
        lbl_titulo.setText("Nuevo Conductor");
    ...
    private void btn_modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modificarActionPerformed
        ...
        if (fil == -1) {
            ...
            System.out.println("cambiando el titulo");
            lbl_titulo.setText("Modificar Conductor");
        ...
        try {
            ...
            if (fila == -1) {
                ...
                if (respuesta == JOptionPane.YES_OPTION) {
                    ...
                    System.out.println("el id_conductor que se eliminara es: " + id_conductor);
                    clase_conductor.eliminar(id_conductor);

                    System.out.println("el Conductor se logró eliminar exitosamente!");
                    System.out.println("ocultar el panel de detalle de datos");
                    Panel_detalle.setVisible(false);
                    JOptionPane.showMessageDialog(null, "El Conductor se Eliminó exitosamente!");
            ...
            JOptionPane.showMessageDialog(null, "Ocurrio al eliminar la Conductor.\n Por favor intentelo nuevamente", "ERROR", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void txt_buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_buscarKeyReleased
        ...
        try {
            System.out.println("select id_conductor, nombre, apellido from tconductor where (nombre like '%" + bus + "%'  or apellido like '%" + bus + "%' or dni like '%" + bus + "%' or direccion like '%" + bus + "%' or sexo like '%" + bus + "%' or telefono like '%" + bus + "%' or celular like '%" + bus + "%' or cargo like '%" + bus + "%' or fecha_nacimiento like '%" + bus + "%' or nro_licencia like '%" + bus + "%') and id_empresa = '" + id_empresa_index + "' order by nombre asc");
            r = sentencia.executeQuery("select id_conductor, nombre, apellido from tconductor where (nombre like '%" + bus + "%'  or apellido like '%" + bus + "%' or dni like '%" + bus + "%' or direccion like '%" + bus + "%' or sexo like '%" + bus + "%' or telefono like '%" + bus + "%' or celular like '%" + bus + "%' or cargo like '%" + bus + "%' or fecha_nacimiento like '%" + bus + "%' or nro_licencia like '%" + bus + "%') and id_empresa = '" + id_empresa_index + "' order by nombre asc");
    ...
    private void tabla_generalMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_generalMouseReleased
        ...
        m = (DefaultTableModel) tabla_general.getModel();
        id_conductor = Integer.parseInt((String) m.getValueAt(fila, 0));
        System.out.println("el id seleccionado es: " + id_conductor);
        id_conductor_global = id_conductor;
        ResultSet r;
        String sexo;

        try {
            r = sentencia.executeQuery("select p.Nombre Nombre, p.Apellido Apellido, p.dni dni, p.direccion direccion, p.telefono telefono, p.celular celular, p.nro_licencia nro_licencia, p.f_creacion f_creacion, p.f_modificacion f_modificacion, u.nombre nombre_usuario from tconductor p, tusuario u where p.id_usuario=u.id_usuario and p.id_conductor=" + id_conductor + "");
            while (r.next()) {
            ...
            JOptionPane.showMessageDialog(null, "Ocurrio al cargar los datos del Conductor", "ERROR", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void btn_cancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cancelarActionPerformed
        int respuesta;
        respuesta = JOptionPane.showConfirmDialog(null, "¿Está seguro que desea Cancelar el registro del Conductor?", "Cancelar", JOptionPane.YES_NO_OPTION);
        if (respuesta == JOptionPane.YES_OPTION) {

            System.out.println("\nCancelar creacion de Conductor");
            System.out.println("==============================");
            ...
            if (txt_dni.getText().length() != 8) {
                ...
                if (crear0_modificar1 == 0) {
                    ...
                    if (band_dni.equals(txt_dni.getText().trim()) && band_nro_licencia.equals(txt_numero_licencia.getText().trim())) {
                        ...
                        int id_conductor = id_conductor_global;
                        System.out.println("llamamos a la funcion modificar_conductor");
                        modificar_conductor(id_conductor, nombre, apellido, dni, direccion, telefono, celular, nro_licencia, id_empresa, id_usuario);
                    } else {
                        if (band_dni.equals(txt_dni.getText().trim()) && !band_nro_licencia.equals(txt_numero_licencia.getText().trim())) {
