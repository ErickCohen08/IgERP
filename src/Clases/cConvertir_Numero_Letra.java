 ...
 * @author ErCO
 */
public class cConvertir_Numero_Letra {

private Integer counter=0;
private String value="";
private String nombreDeMoneda;

public cConvertir_Numero_Letra()
{
...
public String getStringOfNumber(float $num,String mone){
// this.counter = $num;
...
return doThings(_counter) + " " +  "y  " + fraccion + "/100 "+mone ;
}
