 ...
 * @author ErC
 */
public class ProductoView1 extends javax.swing.JPanel {
    ...
    public ProductoView1(String controlador, String DSN, String user, String password, int id_empresa, int id_usuario, String perfil_usuario) {
