...
import Clases.Render_CuentaBanco;
 ...
 * @author ErC
 */
public class Tipo_cotizacion extends javax.swing.JPanel {
    ...
    int id_tipocotizacion_global = 0;
    String estado_global = "";
    String band_descripcion = "";
    private Component tipocotizacion;
    ...
    String objeto_general = "Tipo de Cotización";

    public Tipo_cotizacion(String controlador, String DSN, String user, String password, int id_empresa, int id_usuario, String perfil_usuario) {
...
//        Activar_letras_Mayusculas();
    ...
    private void mostrar_tabla_TipoCotizacion(String consulta) {
        ResultSet r;
        String estado;
        ...
        try {
            ...
            if (consulta.equals("")) {
                r = sentencia.executeQuery("select estado, id_tipocotizacion, descripcion from TTipoCotizacion order by descripcion asc");
            } else {
            ...
            while (r.next()) {
                estado = r.getString("estado").trim();
                ...
                fila[1] = r.getString("id_tipocotizacion").trim();
            ...
            tabla_general.setDefaultRenderer(Object.class, new Render_CuentaBanco());
    ...
    private void crear_TipoCotizacion(String descripcion, String estado, int id_empresa, int id_usuario) {
        ...
        if (clase_TipoCotizacion.crear(descripcion, estado, id_empresa, id_usuario)) {
            System.out.println("\n" + objeto_general + " se logró registrar exitosamente");
            ...
            JOptionPane.showMessageDialog(null, objeto_general + " se registro exitosamente!");

        } else {
            JOptionPane.showMessageDialog(null, "Ocurrio al crear " + objeto_general + ". \nPor favor inténtelo nuevamente.", "ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }

    private void modificar_TipoCotizacion(int id_tipocotizacion, String descripcion, String estado, int id_empresa, int id_usuario) {
        System.out.println("ejecutandose la función: modificar_" + objeto_general + "");

        if (clase_TipoCotizacion.modificar(id_tipocotizacion, descripcion, estado, id_empresa, id_usuario)) {
            System.out.println(objeto_general + " se logró modificar exitosamente!");
            ...
            JOptionPane.showMessageDialog(null, objeto_general + " se modificó exitosamente!");

        } else {
            JOptionPane.showMessageDialog(null, "Ocurrio al modificar " + objeto_general + ". \nPor favor inténtelo nuevamente.", "ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }

    private void mostrar_datos_Cuentabanco(int id_tipocotizacion) {
        ...
        System.out.println("el id seleccionado es: " + id_tipocotizacion);
        id_tipocotizacion_global = id_tipocotizacion;
        ResultSet r;

        try {
            r = sentencia.executeQuery("select d.descripcion descripcion, d.estado estado, d.f_creacion f_creacion, d.f_modificacion f_modificacion, u.nombre nombre_usuario from TTipoCotizacion d, tusuario u where d.id_usuario=u.id_usuario and d.id_tipocotizacion=" + id_tipocotizacion + "");
            while (r.next()) {
                ...
                estado_global = r.getString("estado").trim();
            ...
            lbl_titulo.setText("Información de Forma de Pago");
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/tipo_cotizacion_32_32.png"))); // NOI18N
        jLabel1.setText("Tipos de Cotizacion");
        ...
        btn_activar.setBackground(new java.awt.Color(255, 255, 255));
        btn_activar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/activar_24_4.png"))); // NOI18N
        btn_activar.setText("Activar");
        btn_activar.setFocusable(false);
        btn_activar.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btn_activar.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        btn_activar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_activarActionPerformed(evt);
            }
        });
        jToolBar1.add(btn_activar);
        jToolBar1.add(jSeparator5);

        btn_desactivar.setBackground(new java.awt.Color(255, 255, 255));
        btn_desactivar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/desactivar_24_24.png"))); // NOI18N
        btn_desactivar.setText("Desactivar");
        btn_desactivar.setFocusable(false);
        btn_desactivar.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btn_desactivar.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        btn_desactivar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_desactivarActionPerformed(evt);
            }
        });
        jToolBar1.add(btn_desactivar);
        ...
        jPanel8.setPreferredSize(new java.awt.Dimension(100, 223));
        ...
        jPanel10.setPreferredSize(new java.awt.Dimension(100, 223));
        ...
        jPanel11Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txt_descripcion, javax.swing.GroupLayout.PREFERRED_SIZE, 327, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btn_creacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_creacionActionPerformed
        ...
        dialog_fecha_creacion.setLocationRelativeTo(tipocotizacion);
    ...
    private void btn_nuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_nuevoActionPerformed
        ...
        System.out.println("cambiando el titulo");
        lbl_titulo.setText("Nuevo Tipo de Cotización");
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        ...
        if (txt_descripcion.getText().length() == 0) {
            ...
            if (crear0_modificar1 == 0) {
                ...
                if (clase_TipoCotizacion.descripcion_existente(descripcion) > 0) {
                    ...
                    String estado = "0";
                    crear_TipoCotizacion(descripcion, estado, id_empresa, id_usuario);
                }
            } else {
                System.out.println("crear0_modificar1= " + crear0_modificar1);

                if (band_descripcion.equals(txt_descripcion.getText().trim())) {
                    System.out.println("La descripcion es igual, se procede con la modificacion");
                    int id_tipocotizacion = id_tipocotizacion_global;
                    String estado = estado_global;
                    System.out.println("llamamos a la funcion modificar_" + objeto_general + "");
                    modificar_TipoCotizacion(id_tipocotizacion, descripcion, estado, id_empresa, id_usuario);
    ...
    private void btn_modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modificarActionPerformed
        ...
        if (fil == -1) {
            ...
            System.out.println("cambiando el titulo");
            lbl_titulo.setText("Modificar Tipo de Cotizacion");
            ...
            band_descripcion = txt_descripcion.getText().trim();
            band_index = 1;
        }
        ...
        try {
            ...
            if (fila == -1) {
                ...
                if (respuesta == JOptionPane.YES_OPTION) {
                    ...
                    id_tipocotizacion = Integer.parseInt((String) m.getValueAt(fila, 1));
                    clase_TipoCotizacion.eliminar(id_tipocotizacion);

                    System.out.println(objeto_general + " se logró eliminar exitosamente!");
                    System.out.println("ocultar el panel de detalle de datos");
                    Panel_detalle.setVisible(false);
                    JOptionPane.showMessageDialog(null, "La cuenta se Eliminó exitosamente!");
    ...
    private void tabla_generalMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_generalMouseReleased
        if (band_index == 0) {
            ...
            m = (DefaultTableModel) tabla_general.getModel();
            id_tipocotizacion = Integer.parseInt((String) m.getValueAt(fila, 1));
            mostrar_datos_Cuentabanco(id_tipocotizacion);
        }
    ...
    private void txt_buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_buscarKeyReleased
        ...
        consulta = "select estado, id_tipocotizacion, descripcion from TTipoCotizacion where descripcion like '%" + bus + "%' order by descripcion asc";
        mostrar_tabla_TipoCotizacion(consulta);
    ...
    private void btn_activarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_activarActionPerformed
        System.out.println("Ejecutandose ACTIVAR");
        System.out.println("====================");

        int fila = tabla_general.getSelectedRow();
        int id_tipocotizacion = Integer.parseInt((String) m.getValueAt(fila, 1));
        ResultSet r;

        if (fila == -1) {
            JOptionPane.showMessageDialog(null, "Seleccione un TIPO DE COTIZACION para ACTIVAR");
        } else {
            int respuesta;
            respuesta = JOptionPane.showConfirmDialog(null, "¿Está seguro que desea ACTIVAR esta TIPO DE COTIZACION?", "Anular", JOptionPane.YES_NO_OPTION);
            if (respuesta == JOptionPane.YES_OPTION) {
                String estado = "0";
                int id_usuario = id_usuario_index;

                if (clase_TipoCotizacion.activar(id_tipocotizacion, estado, id_usuario)) {
                    System.out.println("ocultar el panel de detalle de datos");
                    Panel_detalle.setVisible(false);
                    System.out.println("actualizamos tabla TIPO DE COTIZACION");
                    mostrar_tabla_TipoCotizacion("");
                    band_index = 0;

                } else {
                    JOptionPane.showMessageDialog(null, "Ocurrio al ACTIVAR la TIPO DE COTIZACION.\n Por favor intentelo nuevamente", "ERROR", JOptionPane.ERROR_MESSAGE);
                }
            }
        }
    ...
    private void btn_desactivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_desactivarActionPerformed
        System.out.println("Ejecutandose desactivar TIPO DE COTIZACION");
        System.out.println("===========================================");
        ...
        if (fila == -1) {
            JOptionPane.showMessageDialog(null, "Seleccione una TIPO DE COTIZACION para ACTIVAR");
        } else {
            int respuesta;
            respuesta = JOptionPane.showConfirmDialog(null, "¿Está seguro que desea ACTIVAR este TIPO DE COTIZACION?", "Anular", JOptionPane.YES_NO_OPTION);
            if (respuesta == JOptionPane.YES_OPTION) {
                String estado = "1";
                int id_usuario = id_usuario_index;
                ...
                if (clase_TipoCotizacion.activar(id_tipocotizacion, estado, id_usuario)) {
                    ...
                    JOptionPane.showMessageDialog(null, "Ocurrio al ACTIVAR el TIPO DE COTIZACION.\n Por favor intentelo nuevamente", "ERROR", JOptionPane.ERROR_MESSAGE);
                }
            }
        }
