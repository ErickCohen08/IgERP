 ...
 * @author ErC
 */
public class Cuenta_banco extends javax.swing.JPanel {
    ...
    //Clases
    cCuentas_Bancos clase_Cuentabanco = new cCuentas_Bancos();
    DefaultTableModel m;
    //Banderas
    int crear0_modificar1 = 0;
    int id_cuentabanco_global = 0;
    String estado_global = "";
    String band_descripcion = "";
    private Component cuenta_banco;
    ...
    String objeto_general = "Cuenta de Banco";

    public Cuenta_banco(String controlador, String DSN, String user, String password, int id_empresa, int id_usuario, String perfil_usuario) {
...
//        Activar_letras_Mayusculas();
    ...
    private void mostrar_tabla_CuentaBanco(String consulta) {
        ResultSet r;
        String estado;
        ...
        try {
            ...
            if (consulta.equals("")) {
                r = sentencia.executeQuery("select estado, id_cuentabanco, descripcion from TCuentas_Bancos where id_empresa = '" + id_empresa_index + "' order by descripcion asc");
            } else {
            ...
            while (r.next()) {
                ...
                fila[1] = r.getString("id_cuentabanco").trim();
    ...
    private void crear_CuentaBanco(String descripcion, String estado, int id_empresa, int id_usuario) {
        ...
        if (clase_Cuentabanco.crear(descripcion, estado, id_empresa, id_usuario)) {
    ...
    private void modificar_CuentaBanco(int id_cuentabanco, String descripcion, String estado, int id_empresa, int id_usuario) {
        System.out.println("ejecutandose la función: modificar_" + objeto_general + "");

        if (clase_Cuentabanco.modificar(id_cuentabanco, descripcion, estado, id_empresa, id_usuario)) {
    ...
    private void mostrar_datos_Cuentabanco(int id_cuentabanco) {
        ...
        System.out.println("el id seleccionado es: " + id_cuentabanco);
        id_cuentabanco_global = id_cuentabanco;
        ResultSet r;

        try {
            r = sentencia.executeQuery("select d.descripcion descripcion, d.estado estado, d.f_creacion f_creacion, d.f_modificacion f_modificacion, u.nombre nombre_usuario from TCuentas_Bancos d, tusuario u where d.id_usuario=u.id_usuario and d.id_cuentabanco=" + id_cuentabanco + "");
            while (r.next()) {
            ...
            lbl_titulo.setText("Información de la Cuenta");
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/bancos_32_32.png"))); // NOI18N
        jLabel1.setText("Cuentas de Bancos");
        ...
        lbl_titulo.setText("Información de Cuenta de Banco");
        ...
        txt_descripcion.setFont(new java.awt.Font("Arial", 0, 13)); // NOI18N
    ...
    private void btn_creacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_creacionActionPerformed
        ...
        dialog_fecha_creacion.setLocationRelativeTo(cuenta_banco);
    ...
    private void btn_nuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_nuevoActionPerformed
        ...
        System.out.println("cambiando el titulo");
        lbl_titulo.setText("Nueva Cuenta");
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        ...
        if (txt_descripcion.getText().length() == 0) {
            ...
            if (crear0_modificar1 == 0) {
                ...
                if (clase_Cuentabanco.descripcion_existente(descripcion) > 0) {
                ...
                if (band_descripcion.equals(txt_descripcion.getText().trim())) {
                    ...
                    int id_cuentabanco = id_cuentabanco_global;
                    String estado = estado_global;
                    System.out.println("llamamos a la funcion modificar_" + objeto_general + "");
                    modificar_CuentaBanco(id_cuentabanco, descripcion, estado, id_empresa, id_usuario);
        ...
        try {
            ...
            if (fila == -1) {
                ...
                if (respuesta == JOptionPane.YES_OPTION) {
                    ...
                    id_cuentabanco = Integer.parseInt((String) m.getValueAt(fila, 1));
                    clase_Cuentabanco.eliminar(id_cuentabanco);
    ...
    private void tabla_generalMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_generalMouseReleased
        if (band_index == 0) {
            ...
            m = (DefaultTableModel) tabla_general.getModel();
            id_cuentabanco = Integer.parseInt((String) m.getValueAt(fila, 1));
            mostrar_datos_Cuentabanco(id_cuentabanco);
        }
    ...
    private void txt_buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_buscarKeyReleased
        ...
        consulta = "select estado, id_cuentabanco, descripcion from TCuentas_Bancos where (descripcion like '%" + bus + "%') and id_empresa = '" + id_empresa_index + "' order by descripcion asc";
        mostrar_tabla_CuentaBanco(consulta);
    ...
    private void btn_activarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_activarActionPerformed
        System.out.println("Ejecutandose ACTIVAR CUENTA");
        System.out.println("===========================");

        int fila = tabla_general.getSelectedRow();
        int id_cuentabanco = Integer.parseInt((String) m.getValueAt(fila, 1));
        ResultSet r;

        if (fila == -1) {
            JOptionPane.showMessageDialog(null, "Seleccione una CUENTA para ACTIVAR");
        } else {
            int respuesta;
            respuesta = JOptionPane.showConfirmDialog(null, "¿Está seguro que desea ACTIVAR esta CUENTA?", "Anular", JOptionPane.YES_NO_OPTION);
            if (respuesta == JOptionPane.YES_OPTION) {
                String estado = "0";
                int id_usuario = id_usuario_index;

                if (clase_Cuentabanco.activar(id_cuentabanco, estado, id_usuario)) {
                    System.out.println("ocultar el panel de detalle de datos");
                    Panel_detalle.setVisible(false);
                    ...
                    JOptionPane.showMessageDialog(null, "Ocurrio al ACTIVAR la CUENTA.\n Por favor intentelo nuevamente", "ERROR", JOptionPane.ERROR_MESSAGE);
                }
            }
        }
